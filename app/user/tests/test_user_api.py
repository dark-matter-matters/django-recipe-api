...
class PublicUserAPITests(TestCase):
    ...
    def test_password_too_short_error(self):
        """Test error returns if password less than 5 chars"""
        payload = {
            "email": "test@example.com",
            "password": "12",
            "name": "test Name",
    ...
    def test_ceate_token_for_user(self):
    ...
    def test_retrieve_user_unauthorized(self):
        """Test authetication is required for user"""
    ...
    class PrivateUserApiTests(TestCase):
        """Test API requsts that requrie authentication"""
