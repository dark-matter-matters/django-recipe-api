...
def create_recipe(user, **params):
    ...
    defaults = {
        ...
        "link": "http://xample.com/recipe.pdf",
    }
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_update_user_returns_error(self):
        """Test chaning the recipe user results in error"""
    ...
    def test_create_recipe_with_new_ingredients(self):
        payload = {
            ...
            "time_minutes": 60,
            "price": Decimal("3.3"),
            "ingredients": [{"name": "Califlower"}, {"name": "Salf"}],
        }
        res = self.client.post(RECIPES_URL, payload, format="json")
    ...
    def test_crate_recipe_with_existing_ingredient(self):
